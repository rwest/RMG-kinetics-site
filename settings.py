...
DATABASE_NAME = 'RMG_site.db'             # Or path to database file if using sqlite3.
...
TEMPLATE_LOADERS = (
    'django.template.loaders.app_directories.load_template_source', # loads from app_name/templates/
